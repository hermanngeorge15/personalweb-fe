...
export interface ContactAdminControllerApiInterface {
     ...
     */
    handleRaw(requestParameters: HandleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>>;

    /**
     */
    handle(requestParameters: HandleRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void>;
     ...
     * @memberof ContactAdminControllerApiInterface
     */
    list4Raw(requestParameters: List4Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ContactMessageEntity>>>;

    /**
     */
    list4(requestParameters: List4Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ContactMessageEntity>>;
 ...
 * 
 */
export class ContactAdminControllerApi extends runtime.BaseAPI implements ContactAdminControllerApiInterface {
    ...
    /**
     */
    async list4Raw(requestParameters: List4Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<ContactMessageEntity>>> {
        const queryParameters: any = {};
    ...
    /**
     */
    async list4(requestParameters: List4Request = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Array<ContactMessageEntity>> {
