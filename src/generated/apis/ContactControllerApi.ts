...
import type { ContactRequest } from '../models/index'
import { ContactRequestFromJSON, ContactRequestToJSON } from '../models/index'
 ...
 *
 */
export class ContactControllerApi
  extends runtime.BaseAPI
  implements ContactControllerApiInterface
{
  /**
   */
  async submitRaw(
    ...
    if (requestParameters['xForwardedFor'] != null) {
      headerParameters['X-Forwarded-For'] = String(
        requestParameters['xForwardedFor'],
      )
    }
