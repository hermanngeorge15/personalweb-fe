...
import type { ProjectDto, ProjectUpsertRequest } from '../models/index'
import {
  ProjectDtoFromJSON,
  ProjectDtoToJSON,
 ...
 *
 */
export class ProjectControllerApi
  extends runtime.BaseAPI
  implements ProjectControllerApiInterface
{
  /**
   */
  async create1Raw(
    ...
    const response = await this.request(
      {
        ...
        body: ProjectUpsertRequestToJSON(
          requestParameters['projectUpsertRequest'],
        ),
      },
      initOverrides,
    )
