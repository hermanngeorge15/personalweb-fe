 ...
 */
export function instanceOfTestimonialUpsertRequest(
  value: object,
): value is TestimonialUpsertRequest {
  return true
}

export function TestimonialUpsertRequestFromJSON(
  json: any,
): TestimonialUpsertRequest {
  return TestimonialUpsertRequestFromJSONTyped(json, false)
}

export function TestimonialUpsertRequestFromJSONTyped(
  json: any,
...
export function TestimonialUpsertRequestToJSON(
  json: any,
): TestimonialUpsertRequest {
  return TestimonialUpsertRequestToJSONTyped(json, false)
}

export function TestimonialUpsertRequestToJSONTyped(
  value?: TestimonialUpsertRequest | null,
