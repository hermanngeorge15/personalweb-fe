...
function HomePage() {
  ...
  useEffect(() => {
    ...
    setJsonLd({
      ...
      description: 'Backend Software Engineer specializing in Kotlin, Java, Spring Boot, and scalable systems. Founder of Kotlin Server Squad.',
      knowsAbout: ['Kotlin', 'Java', 'Spring Boot', 'Webflux', 'Backend Development', 'Microservices'],
    })
  }, [])
  return (
    <AppShell path="Home / Overview">
          ...
          <div className="order-2 md:order-1">
            ...
            <div className="mt-4 grid gap-3">
              <p className="text-base leading-relaxed text-gray-700">
                Hi there! My name is <strong className="text-gray-900">Jiří Hermann</strong>, and I'm a <strong className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Backend Software Engineer</strong> and <strong className="bg-gradient-to-r from-cyan-600 to-green-600 bg-clip-text text-transparent">Community Builder</strong> passionate about designing clean, reliable, and scalable systems.
              </p>
              <p className="text-base leading-relaxed text-gray-700">
                I'm based in <strong className="text-gray-900">Prague, Czech Republic</strong>, and I love turning complex ideas into well-structured backend solutions using <span className="font-semibold text-blue-700">Kotlin</span> and <span className="font-semibold text-blue-700">Java</span>. My work revolves around <span className="font-medium text-gray-800">Spring Boot</span>, <span className="font-medium text-gray-800">Micronaut</span>, <span className="font-medium text-gray-800">PostgreSQL</span>, <span className="font-medium text-gray-800">Redis</span>, <span className="font-medium text-gray-800">Kafka</span>, and <span className="font-medium text-gray-800">Docker</span>, always with a focus on clean architecture and automation.
              </p>
              <p className="text-base leading-relaxed text-gray-700">
                Beyond engineering, I'm the founder of <a href="https://kotlinserversquad.com/" target="_blank" rel="noopener noreferrer" className="inline-block bg-gradient-to-r from-blue-600 via-cyan-600 to-green-600 bg-clip-text font-bold text-transparent transition-all hover:from-blue-700 hover:via-cyan-700 hover:to-green-700 hover:underline">Kotlin Server Squad</a> — a community for developers who share a passion for building, learning, and helping each other grow. It's not just about Kotlin; it's about connecting people across the JVM world and creating a space where ideas come to life.
              </p>
              <p className="text-base leading-relaxed text-gray-700">
                Recently, I've been exploring <span className="font-semibold text-cyan-700">frontend development</span> with <span className="font-medium text-gray-800">React</span> and <span className="font-medium text-gray-800">TypeScript</span> to better understand full-stack workflows and bridge the gap between backend and user experience.
              </p>
              <p className="text-base leading-relaxed text-gray-700">
                If you're looking for a dedicated engineer who builds with purpose and fosters community, I'd love to connect and see how we can collaborate.
              </p>
            </div>
            <div className="mt-6 flex flex-wrap gap-3">
              <Link to="/contact">
                <Button color="primary" variant="solid" className="shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30">Get in touch</Button>
              </Link>
              <Link to="/services">
                <Button variant="bordered" className="hover:translate-y-[1px] transition-transform">Services</Button>
              </Link>
              <Link to="/resume">
                <Button variant="light" className="hover:underline">Resume</Button>
              </Link>
            </div>
            <div className="mt-6 flex items-center gap-3">
              ...
              >
                <svg viewBox="0 0 24 24" className="h-5 w-5 text-gray-700 group-hover:text-blue-600" fill="currentColor" aria-hidden="true">
      ...
      <MotionSection variant="fade-up" id="core-skillset">
        <div className="relative overflow-hidden rounded-3xl border border-cyan-200/50 bg-white/40 p-8 shadow-lg ring-1 ring-cyan-500/10 backdrop-blur md:p-12">
          ...
          <div className="pointer-events-none absolute -left-20 -bottom-20 h-48 w-48 rounded-full bg-gradient-to-tr from-cyan-400/20 via-teal-400/10 to-green-400/10 blur-3xl" />
          <div className="relative grid gap-6 md:gap-8">
            ...
            {[
              { title: 'Backend Development', body: 'CraftiDeveloping scalable services, integrations, and business logic' },
              { title: 'Java / Kotlin', body: 'Building clean, maintainable backend systems on the JVM'},
              { title: 'Spring Boot / Webflux', body: 'Extensive experience across Spring Boot and Webflux.' },
            ].map((s) => (
              <Card key={s.title} className="transition-all hover:-translate-y-[2px] hover:shadow-lg">
              ...
              {posts.data.items.map((p) => (
                <Link key={p.slug} to="/blog/$slug" params={{ slug: p.slug }} className="group">
                  <Card className="h-full cursor-pointer transition-all hover:-translate-y-1 hover:shadow-xl">
                    <CardBody>
                      <div className="text-lg font-semibold group-hover:text-blue-600 transition-colors">{p.title}</div>
                      <div className="text-muted-foreground mt-2">{p.excerpt}</div>
