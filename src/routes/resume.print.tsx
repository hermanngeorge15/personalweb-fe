...
function PrintResumePage() {
  ...
  return (
    <AppShell path="Resume / Print">
      <section className="mx-auto grid max-w-[794px] gap-4 rounded border bg-white p-6 shadow print:max-w-[794px] print:rounded-none print:border-0 print:p-0 print:shadow-none">
          ...
          <section className="grid gap-2">
            ...
            <ul className="grid gap-2">
              {education.data.map((e) => (
                <li
                  key={e.id}
                  className="flex break-inside-avoid items-baseline justify-between"
                >
                  <div>
